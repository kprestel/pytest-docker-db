# -*- coding: utf-8 -*-
#
# pytest-docker-db documentation build configuration file, created by
...
project = u'pytest-docker-db'
copyright = u'2015, Kyle Prestel'
author = u'Kyle Prestel'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-docker-db Documentation',
     [author], 1)
]
